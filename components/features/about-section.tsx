  ...
  return (
    ...
    >
      ...
      <div className="p-6 space-y-6">
        ...
        {/* Technology Stack */}
        <section className="bg-gray-50 dark:bg-dark-bg-tertiary rounded-lg p-4 space-y-3">
          <h4 className="font-semibold text-gray-900 dark:text-dark-text-primary text-sm flex items-center gap-2">
...
function TrustCard({ icon, title, description, badge }: TrustCardProps) {
  return (
    <div className="p-4 bg-gradient-to-br from-gray-50 to-gray-100 dark:from-dark-bg-tertiary dark:to-dark-bg-primary border border-gray-200 dark:border-gray-700 rounded-lg">
      <div className="flex items-start gap-3 mb-2">
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="text-xs text-gray-600 dark:text-dark-text-tertiary leading-relaxed">
            {description}
          </div>
        </div>
      </div>
...
function ProjectLink({ href, icon, title, description }: ProjectLinkProps) {
  return (
    <a
      ...
      target="_blank"
      rel="noopener noreferrer"
      className="flex items-start gap-3 p-3 bg-white dark:bg-dark-bg-primary border border-gray-200 dark:border-gray-700 rounded-lg hover:border-indigo-300 dark:hover:border-indigo-700 hover:shadow-sm transition-all group"
    >
      ...
      <div className="flex-1 min-w-0">
        <div className="font-medium text-gray-900 dark:text-dark-text-primary text-sm group-hover:text-indigo-600 dark:group-hover:text-indigo-400 transition-colors">
          {title}
        </div>
...
function TechBadge({ name }: TechBadgeProps) {
  return (
    <span className="inline-flex items-center px-3 py-1 bg-white dark:bg-dark-bg-primary border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-dark-text-secondary rounded-full text-xs font-medium">
      {name}
    </span>
  )
}
